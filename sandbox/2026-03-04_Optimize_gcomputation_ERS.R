...
# Does not use data.table
estimate_ERS_old <- function(Y, X, C, x_eval = NULL, 
...
# Uses data.table
estimate_ERS_new <- function(Y, X, C, x_eval = NULL, 
                         estimator = c("DR", "RA", "IPW"), 
                         out_model = NULL, 
                         gps_model = NULL, 
                         h = NULL, 
...
time_old <- system.time({
  res_ra <- estimate_ERS_old(Y, X, C, estimator = "DR", out_model = out_mod, gps_model = gps_mod)
})

time_new <- system.time({
  res_ra <- estimate_ERS_new(Y, X, C, estimator = "DR", out_model = out_mod, gps_model = gps_mod)
})

message("Old time: ", time_old["elapsed"])
message("New time: ", time_new["elapsed"])
